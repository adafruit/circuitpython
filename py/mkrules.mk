...
# CIRCUITPY-CHANGE: CircuitPython compiles with -std=gnu11, so filter that out too.
CXXFLAGS += $(filter-out -Wmissing-prototypes -Wold-style-definition -std=gnu99 -std=c99 -std=c11 -std=gnu11,$(CFLAGS) $(CXXFLAGS_MOD))
