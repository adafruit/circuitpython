/*
 * This is a copy of esp-idf/components/ulp/ulp_riscv/ulp_riscv.c.
 * This copy is necessary as a workaround for this Issue https://github.com/espressif/esp-idf/issues/12999.
 * Once that issue has been resolved, this file can be deleted.
 */
