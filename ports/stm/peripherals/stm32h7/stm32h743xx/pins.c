...
const mcu_pin_obj_t pin_PB00 = PIN(1, 0, ADC_INPUT(ADC_12, 9));
...
const mcu_pin_obj_t pin_PC03 = PIN(2, 3, ADC_INPUT(ADC_12, 13));
const mcu_pin_obj_t pin_PC04 = PIN(2, 4, ADC_INPUT(ADC_12, 4));
const mcu_pin_obj_t pin_PC05 = PIN(2, 5, ADC_INPUT(ADC_12, 8));
...
const mcu_pin_obj_t pin_PF03 = PIN(5, 3, ADC_INPUT(ADC_3, 5));
const mcu_pin_obj_t pin_PF04 = PIN(5, 4, ADC_INPUT(ADC_3, 9));
const mcu_pin_obj_t pin_PF05 = PIN(5, 5, ADC_INPUT(ADC_3, 4));
const mcu_pin_obj_t pin_PF06 = PIN(5, 6, ADC_INPUT(ADC_3, 8));
const mcu_pin_obj_t pin_PF07 = PIN(5, 7, ADC_INPUT(ADC_3, 3));
const mcu_pin_obj_t pin_PF08 = PIN(5, 8, ADC_INPUT(ADC_3, 7));
const mcu_pin_obj_t pin_PF09 = PIN(5, 9, ADC_INPUT(ADC_3, 2));
...
const mcu_pin_obj_t pin_PH02 = PIN(7, 2, ADC_INPUT(ADC_3, 13));
const mcu_pin_obj_t pin_PH03 = PIN(7, 3, ADC_INPUT(ADC_3, 14));
const mcu_pin_obj_t pin_PH04 = PIN(7, 4, ADC_INPUT(ADC_3, 15));
const mcu_pin_obj_t pin_PH05 = PIN(7, 5, ADC_INPUT(ADC_3, 16));
