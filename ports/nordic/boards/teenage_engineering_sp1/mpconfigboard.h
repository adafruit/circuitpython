...
// reflashing window. mpconfigboard.mk keeps CIRCUITPY_WATCHDOG off to match.
#define CIRCUITPY_BOOTLOADER_ARMED_WDT (1)

// Hardware-write-protect everything outside the nvm and CIRCUITPY regions for
// the life of each boot. The FAT ends at 0xBF000 + 256 KiB =
// 0xFF000, which is exactly where the bootloader settings page begins.
#define CIRCUITPY_NRF_FLASH_PROTECT (1)
