...
static mp_obj_t audiobusio_i2sout_make_new(const mp_obj_type_t *type, size_t n_args, size_t n_kw, const mp_obj_t *all_args) {
    ...
    #else
    enum { ARG_bit_clock, ARG_word_select, ARG_data, ARG_main_clock, ARG_left_justified, ARG_clock_follower };
    static const mp_arg_t allowed_args[] = {
        ...
        { MP_QSTR_clock_follower, MP_ARG_BOOL | MP_ARG_KW_ONLY, {.u_bool = false} },
    };
    ...
    common_hal_audiobusio_i2sout_construct(self, bit_clock, word_select, data, main_clock,
        args[ARG_left_justified].u_bool, clock_follower);
