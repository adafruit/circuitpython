...
#define SOCKET_BLOCK_FOREVER ((mp_uint_t)-1)
...
int common_hal_socketpool_socket_bind(socketpool_socket_obj_t *self, const char *host, size_t hostlen, uint32_t port);
