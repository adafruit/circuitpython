...
# -*- coding: utf-8 -*-
"""
CircuitPython Documentation Configuration
...
Key Features:
- Generates module support matrices from shared-bindings
- Includes custom redirect handling
- Configures intersphinx for Python/CircuitPython references
- Sets up AutoAPI for stub documentation

Note: Many settings are inherited from the original MicroPython configuration.
"""
